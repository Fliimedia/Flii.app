...
const I18N = {
  nl: {
    ...
    work: { eyebrow: "flii.labs", h2: "Uit de hobbykamer", lede: "Live producten en experimenten die we nu bij flii.labs bouwen en itereren.", manage: "Beheer showcase ↗", view: "Bekijk case ↗" },
  ...
  en: {
    ...
    work: { eyebrow: "flii.labs", h2: "Fresh from the workshop", lede: "Live products and experiments we are building and iterating at flii.labs right now.", manage: "Manage showcase ↗", view: "View case ↗" },
