...
const I18N = {
  nl: {
    ...
    mega: {
      ...
      featureK: "De Flii Loop", featureT: "Bouwen en groeien als één systeem →",
    },
    hero: { pre: "AI architectuur als fundament van ", mark: "resultaat", post: "",
      ...
      primary: "Plan een gesprek", secondary: "Bekijk de loop ↘" },
    ...
    loop: { eyebrow: "De Flii Loop", h2: "Eén loop. Groei die optelt.",
      lede: "Bouw en marketing draaien als één systeem. Elk signaal scherpt de volgende zet aan.",
      items: [
        { k: "Signaal", body: "Bepaal doel, doelgroep en data voordat er iets gebouwd wordt." },
        { k: "Bouwen", body: "AI-versneld ontwerp en development, snel gelanceerd en gemeten." },
        { k: "Schalen", body: "Performance-marketing giet brandstof op wat al converteert." },
        { k: "Loop", body: "Elk resultaat voedt de volgende zet. Scherper naarmate het draait." } ] },
  ...
  en: {
    ...
    mega: {
      ...
      featureK: "The Flii Loop", featureT: "Build and grow as one system →",
    },
    hero: { pre: "AI architecture as the foundation of ", mark: "results", post: "",
      ...
      primary: "Book a consultation", secondary: "See the loop ↘" },
    ...
    loop: { eyebrow: "The Flii Loop", h2: "One loop. Compounding gains.",
      lede: "Build and marketing run as one system. Every signal sharpens the next move.",
      items: [
        { k: "Signal", body: "Map the goal, audience and data before anything is built." },
        { k: "Build", body: "AI-accelerated design and dev, shipped fast and measured." },
        { k: "Scale", body: "Performance marketing pours fuel on what already converts." },
        { k: "Loop", body: "Every result feeds the next move. Sharper the longer it runs." } ] },
        ...
        <div className="wrap">
          ...
          <div className="loop-grid">
            {t.loop.items.map((l, i) => (
              <Section key={i} className="loop-item" style={{ transitionDelay: `${i * 80}ms` }}>
                <div className="loop-k mono">{String(i + 1).padStart(2, "0")} · {l.k}</div><p className="loop-body">{l.body}</p>
              </Section>
            ))}
          </div>
        </div>
...
/* loop */
.loop-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;margin-top:48px;}
.loop-item{border-top:2px solid rgba(231,37,90,0.45);padding-top:18px;}
.loop-k{font-size:13px;color:var(--mag);margin-bottom:12px;}
.loop-body{font-size:14.5px;color:#C9C6BD;margin:0;}
...
@media(max-width:720px){
  ...
  .service-grid,.stats-grid,.loop-grid,.aud-grid,.steps-grid,.footer-grid,.quote-grid,.contact-grid,.brandwall,.creds-row{grid-template-columns:1fr;}
